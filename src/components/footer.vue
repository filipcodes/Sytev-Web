  ...
  <footer class="footer">
    <div class="container">
      <div class="footer__top">
        <img
          class="footer__logo"
          src="../assets/images/sytev_logo_white.png"
          alt="Logo of Sytev"
        />
        <div class="footer__section">
          <h3 class="footer__title">Daj nám follow</h3>
        ...
        <div class="footer__section">
          <h3 class="footer__title">Linky</h3>
        ...
        <div class="footer__section">
          ...
          <div class="footer__contact__container">
            ...
            <span class="footer__contact__info">
              ...
              <a href="tel:+421 910 489 591">+421 910 489 591</a>
            </span>
            <span class="footer__contact__info">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="mailto: office@sytev.com">office@sytev.com</a>
            </span>
          </div>
        </div>
      </div>
